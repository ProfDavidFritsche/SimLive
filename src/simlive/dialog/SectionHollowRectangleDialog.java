...
public class SectionHollowRectangleDialog extends Composite {
	
	private Text text_3, text_4, text_5, text_6;
	
	public SectionHollowRectangleDialog(final Composite parent, int style,
		...
		text.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetDefaultSelected(SelectionEvent e) {
				...
				text_3.setText(SimLive.double2String(section.getArea()));
				text_4.setText(SimLive.double2String(section.getIy()));
				text_5.setText(SimLive.double2String(section.getIz()));
				text_6.setText(SimLive.double2String(section.getIt()));
		...
		text_2.setText(SimLive.double2String(section.getSectionShape().getThickness()));
		...
		lblUnit_6.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 1, 1));
