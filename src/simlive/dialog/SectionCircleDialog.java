...
public class SectionCircleDialog extends Composite {
	
	private Text text_1, text_2, text_3;

	public SectionCircleDialog(final Composite parent, int style,
		...
		text.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetDefaultSelected(SelectionEvent e) {
				...
				text_1.setText(SimLive.double2String(section.getArea()));
				text_2.setText(SimLive.double2String(section.getIy()));
