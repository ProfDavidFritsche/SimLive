...
public abstract class Search {
	...
	public static void getCoordsAtGridLine(int[] point, final double snapTol) {
		double gridSize = Settings.meshSize;
		...
		if (Settings.isShowGrid && Math.abs(View.R0.get(2, 2)) > SimLive.ZERO_TOL &&
				i <= Settings.meshCount/2 && i >= -Settings.meshCount/2 &&
				j <= Settings.meshCount/2 && j >= -Settings.meshCount/2) {
